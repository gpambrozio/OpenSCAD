...
motor_shaft = 5.7;	// NEMA17 motor shaft exact diameter = 5
...
pulley_t_ht = 10 - 2;	// length of toothed part of pulley, standard = 12
...
union() {
    ...
    difference() {
        ...
        translate([0, 0, -motor_h + screw_d]) rotate([90 , 0, 0]) cylinder(r=m3_dia/2,h=pulley_b_dia/2+1);
        translate([0, -m3_nut_depth / 2 - motor_shaft / 2 - 1.5, - motor_h / 2]) cube([m3_nut_flats, m3_nut_depth, motor_h + 2], center=true);
